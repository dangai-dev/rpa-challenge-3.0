...
class ApNewsRobot:
    ...
    def run(self):
        try:
            self.start()
            Helper.excel_generator(Scraper.fetch_posts(self))
    ...
    def search(self):
        logging.info(f"...SELECTED FILTER: {SEARCH_TEXT}...")
    ...
    def sort_posts(self):
        ...
        self.browser.wait_until_element_is_visible(Locators.SORT_SELECT, 4000)
        self.browser.click_element_when_visible(Locators.SORT_SELECT)

        self.browser.wait_until_element_is_visible(
            Locators.SORT_SELECT_NEWEST_OPTION, 4000
        )
